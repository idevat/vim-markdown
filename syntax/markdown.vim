...
"HTML headings
syn region htmlH1       matchgroup=mkdHeading     start="^\s*#\s*"                   end="$" contains=mkdLink,mkdInlineURL,@Spell concealends
syn region htmlH2       matchgroup=mkdHeading     start="^\s*##\s*"                  end="$" contains=mkdLink,mkdInlineURL,@Spell concealends
syn region htmlH3       matchgroup=mkdHeading     start="^\s*###\s*"                 end="$" contains=mkdLink,mkdInlineURL,@Spell concealends
syn region htmlH4       matchgroup=mkdHeading     start="^\s*####\s*"                end="$" contains=mkdLink,mkdInlineURL,@Spell concealends
syn region htmlH5       matchgroup=mkdHeading     start="^\s*#####\s*"               end="$" contains=mkdLink,mkdInlineURL,@Spell concealends
syn region htmlH6       matchgroup=mkdHeading     start="^\s*######\s*"              end="$" contains=mkdLink,mkdInlineURL,@Spell concealends
